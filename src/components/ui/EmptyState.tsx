  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-6 text-center">
      ...
      <svg width="120" height="100" viewBox="0 0 120 100" fill="none" className="mb-6 opacity-60">
        <rect x="20" y="20" width="80" height="60" rx="8" fill="#E7E8F4" stroke="#4B519E" strokeWidth="2"/>
        <rect x="32" y="34" width="40" height="4" rx="2" fill="#4B519E" opacity="0.4"/>
        <rect x="32" y="44" width="56" height="4" rx="2" fill="#4B519E" opacity="0.25"/>
        <rect x="32" y="54" width="48" height="4" rx="2" fill="#4B519E" opacity="0.2"/>
        <circle cx="90" cy="72" r="18" fill="#4B519E"/>
